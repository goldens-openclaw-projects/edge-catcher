...
# ---------------------------------------------------------------------------
# StrategyH1 unit tests
# ---------------------------------------------------------------------------

class TestStrategyH1:
	def test_fade_first_trade_above_threshold_buys_no(self):
		strategy = StrategyH1(threshold_high=60, threshold_low=40)
		port = Portfolio(10000.0)
		market = _make_market()
	...
	def test_take_profit_exit_no_position(self):
		...
		strategy = StrategyH1(threshold_high=60, threshold_low=40, take_profit=8, stop_loss=5)
		port = Portfolio(10000.0)
		market = _make_market()
