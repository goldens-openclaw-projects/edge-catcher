...
def _build_strategy_map():
    ...
    if local_mod is not None:
        strategy_map.update({
            'sweet-spot': local_mod.StrategyA,
            'sweet-spot-vol': local_mod.StrategyA_VolumeFiltered,
            'contra-dip': local_mod.StrategyB,
            'fade-long': local_mod.StrategyC,
            'fade-long-vol': local_mod.StrategyC_VolumeFiltered,
            'debut-fade': local_mod.StrategyD,
            'TP': local_mod.StrategyTP,
            'flb-15m': local_mod.StrategyH5_15m,
            'A': local_mod.StrategyA, 'Avol': local_mod.StrategyA_VolumeFiltered,
            'B': local_mod.StrategyB, 'C': local_mod.StrategyC, 'Cvol': local_mod.StrategyC_VolumeFiltered,
            'D': local_mod.StrategyD, 'H1': local_mod.StrategyD,
            'Dvol': local_mod.StrategyD_VolumeFiltered, 'debut-fade-vol': local_mod.StrategyD_VolumeFiltered,
            'Amom': local_mod.StrategyA_MomentumFiltered, 'sweet-spot-mom': local_mod.StrategyA_MomentumFiltered,
            'Cmom': local_mod.StrategyC_MomentumFiltered, 'fade-long-mom': local_mod.StrategyC_MomentumFiltered,
            'Cstack': local_mod.StrategyC_StackedFilters, 'fade-long-stacked': local_mod.StrategyC_StackedFilters,
            'H5_15m': local_mod.StrategyH5_15m, 'H5_15M': local_mod.StrategyH5_15m,
            'Fflow': local_mod.StrategyFlowFade, 'flow-fade': local_mod.StrategyFlowFade,
            'Ffvol': local_mod.StrategyFlowFade_VolumeFiltered, 'flow-fade-vol': local_mod.StrategyFlowFade_VolumeFiltered,
        })
...
def _cmd_backtest(args) -> None:
    ...
    try:
        ...
        for name in strategy_names:
            ...
            if name in ('H5_15M', 'H5_15m', 'flb-15m'):
...
def main() -> None:
    ...
    bt.add_argument("--tp", type=int, default=None, help="Take profit cents for StrategyTP (default: 8)")
    bt.add_argument("--sl", type=int, default=None, help="Stop loss cents for StrategyTP (default: 5)")
